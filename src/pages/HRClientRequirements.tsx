...
export default function ClientRequirementsPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 p-6">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-slate-100 mb-2">Client Requirements</h2>
        <p className="text-slate-400">Track document submissions and requirements.</p>
      </div>
      ...
      <div className="bg-slate-900 rounded-xl border border-slate-800 shadow-sm">
        <div className="px-6 py-4 border-b border-slate-800">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-lg font-semibold text-slate-100">Document Requirements</h3>
              <p className="text-sm text-slate-400 mt-1">Manage client document submissions and track their status</p>
            </div>
          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-slate-800">
              {requirements.map((requirement) => (
                <tr key={requirement.id} className="hover:bg-slate-800/60 transition-colors">
                  ...
                  <td className="py-4 px-6 text-sm text-slate-200">{requirement.client}</td>
                  <td className="py-4 px-6">
                    <span
                  ...
                  <td className="py-4 px-6 text-sm text-slate-400">{requirement.submittedDate || "Not submitted"}</td>
                  <td className="py-4 px-6 text-sm text-slate-400">{requirement.dueDate}</td>
